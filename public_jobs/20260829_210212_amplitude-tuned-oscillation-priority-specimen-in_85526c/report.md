# Amplitude-tuned oscillation-priority specimen inference
...
constrained fit gives **1267.2**,
**11/22** correct classifications, and
predicts **0** oscillating traces.
The relaxed diagnostic fit gives **464.25**,
**19/22** correct classifications, and
