# Measured laboratory current sweep with onset bracket
...
The immediately preceding record is `250mv0_converted.csv` at **250 mV drive**. Its fixed 50--250 ns analysis window contains only **1 candidate peak**, so no periodic frequency is assigned.
