...
\bottomrule
\end{tabular}
\caption{Sample-specific resistance parameters compared with Yuanhang's reference implementation. Yuanhang's displayed metallic floor is $R_m=R_{m0}f_m=(262.5~\Omega)(4.90025335)=1286.32~\Omega$. $R_0$ and $E_a/k_B$ are strongly correlated; their joint combination determines the insulating branch.}
