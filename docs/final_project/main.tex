...
The $300$~mV drive record is the first trace with coherent oscillation. We therefore selected the immediately preceding $250$~mV record as the closest measured point below switching onset. We did not use the first transition during the current edge because the device is still heating there and $dT/dt=0$ would not be justified.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../../public_jobs/20260817_152216_environmental-thermal-conductance-estimate_c4be6c/figures/environmental_conductance.png}
...
Result & Value \\
\midrule
Selected trace & $250$~mV drive \\
First oscillating trace & $300$~mV drive \\
...
\begin{center}
\footnotesize
\path{20260817_152216_environmental-thermal-conductance-estimate_c4be6c}.
\end{center}
